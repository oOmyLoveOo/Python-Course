# Solucionario: POO y Herencia en Python - Sistema de Biblioteca Avanzado
...
class ElementoBiblioteca:
    ...
    def __str__(self):
        return f"{self.__class__.__name__}: {self.titulo}, Código: {self.codigo}, Prestado: {'Sí' if self.prestado else 'No'}"
