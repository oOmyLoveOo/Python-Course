...
def verificar_implementacion():
    ...
    try:
        ...
        print(f"❌ Prueba 6 fallida: crear_persona no funciona como se esperaba. Error: {e}")
    ...
    try:
        ...
        print(f"❌ Prueba 10 fallida: medir_tiempo no funciona como se esperaba. Error: {e}")
