# Actividad: Polimorfismo en Programación Orientada a Objetos en Python

"""
Instrucciones para el estudiante:

1. Lee cuidadosamente los comentarios en cada función y clase.
2. Completa los espacios marcados con ___ usando los conceptos de polimorfismo en POO.
...
class Perro(Animal):
    def hacer_sonido(self):
        """
        Implementa el método hacer_sonido para la clase Perro.
        Debe retornar "Guau!"
        """
        return f"Guau!"
...
class Gato(Animal):
    def hacer_sonido(self):
        """
        Implementa el método hacer_sonido para la clase Gato.
        Debe retornar "Miau!"
        """
        return f"Miau!"
...
class Pato(Animal):
    def hacer_sonido(self):
        """
        Implementa el método hacer_sonido para la clase Pato.
        Debe retornar "Cuac!"
        """
        return f"Cuac!"
...
def sonido_animal(animal):
    """
    Esta función debe hacer que el animal pasado como argumento haga su sonido.
    Debe funcionar con cualquier objeto que tenga un método hacer_sonido.
    """
...
class Punto:
    ...
    def __str__(self):
        """
        Implementa el método __str__ para representar el punto como string.
        Debe retornar "(x, y)"
        """
    ...
    def __add__(self, otro):
        """
        Implementa el método __add__ para sumar dos puntos.
        Debe retornar un nuevo Punto con las coordenadas sumadas.
        """
...
class Rectangulo:
    ...
    def area(self):
        """
        Implementa el método area para calcular el área del rectángulo.
        """
...
class Circulo:
    ...
    def area(self):
        """
        Implementa el método area para calcular el área del círculo.
        Usa 3.14 como valor de pi.
        """
        return 3.14 * self.radio ** 2

def calcular_area(figura):
    """
    Esta función debe calcular y retornar el área de la figura pasada como argumento.
    Debe funcionar tanto para Rectangulo como para Circulo.
    """
    return figura.area()
